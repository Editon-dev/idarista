...
<div class="container">
	...
	<h1>FORMULARIO DE CONTRATANTE</h1><hr><br>
	Nome Completo*: <input type="text" name="nome" ID="nome" maxlength="200" autofocus="1" required><br><br>
	Data de Nascimento*: <input type="date" name="nascimento" ID="nascimento" value=""> <br><br>
	...
	Telefone*: <input type="tel" ID="telefone" name="telefone" maxlength="9" title="Apenas números" pattern="[0-9]{5,4}-[0-9]{4}" required placeholder="Digite seu telefone"><br><br>
	...
	Número do Cartão*: <input type="text" ID="cartao" name="cartao" maxlength="20" placeholder="Digite o número do cartão" required> CVC*: <input type="text" ID="cvc" name="cvc" size="3" maxlength="3" placeholder="Ex: 123"> <img src="img/bandeira-cartao.png" width="200" height="25"><br><br>
	...
	<hr>
	Escolha o tipo de contratante*: <br><br>
	<div class="radio-row">
	<input type="radio" name="regras" ID="regras" value="cont_normal" onclick="mudaPag(this, 'cont')"><div>Regras Contratante Normal</div> <input type="radio" name="regras" ID="regras" value="cont_contribuinte" onclick="mudaPag(this, 'cont')"><div>Regras Contratante Contribuinte</div><br><br>
	</div>
